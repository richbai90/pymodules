...
KSC_TrigDisabled = _solenoid.KSC_TrigDisabled
KSC_TrigIn_GPI = _solenoid.KSC_TrigIn_GPI
KSC_TrigOut_GPO = _solenoid.KSC_TrigOut_GPO
KSC_TrigPolarityHigh = _solenoid.KSC_TrigPolarityHigh
KSC_TrigPolarityLow = _solenoid.KSC_TrigPolarityLow
class KSC_MMIParams(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    unused = property(_solenoid.KSC_MMIParams_unused_get, _solenoid.KSC_MMIParams_unused_set)
    DisplayIntensity = property(_solenoid.KSC_MMIParams_DisplayIntensity_get, _solenoid.KSC_MMIParams_DisplayIntensity_set)
    DisplayTimeout = property(_solenoid.KSC_MMIParams_DisplayTimeout_get, _solenoid.KSC_MMIParams_DisplayTimeout_set)
    DisplayDimIntensity = property(_solenoid.KSC_MMIParams_DisplayDimIntensity_get, _solenoid.KSC_MMIParams_DisplayDimIntensity_set)
    reserved = property(_solenoid.KSC_MMIParams_reserved_get, _solenoid.KSC_MMIParams_reserved_set)

    def __init__(self):
        _solenoid.KSC_MMIParams_swiginit(self, _solenoid.new_KSC_MMIParams())
    __swig_destroy__ = _solenoid.delete_KSC_MMIParams

# Register KSC_MMIParams in _solenoid:
_solenoid.KSC_MMIParams_swigregister(KSC_MMIParams)
class KSC_TriggerConfig(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    Trigger1Mode = property(_solenoid.KSC_TriggerConfig_Trigger1Mode_get, _solenoid.KSC_TriggerConfig_Trigger1Mode_set)
    Trigger1Polarity = property(_solenoid.KSC_TriggerConfig_Trigger1Polarity_get, _solenoid.KSC_TriggerConfig_Trigger1Polarity_set)
    Trigger2Mode = property(_solenoid.KSC_TriggerConfig_Trigger2Mode_get, _solenoid.KSC_TriggerConfig_Trigger2Mode_set)
    Trigger2Polarity = property(_solenoid.KSC_TriggerConfig_Trigger2Polarity_get, _solenoid.KSC_TriggerConfig_Trigger2Polarity_set)
    reserved = property(_solenoid.KSC_TriggerConfig_reserved_get, _solenoid.KSC_TriggerConfig_reserved_set)

    def __init__(self):
        _solenoid.KSC_TriggerConfig_swiginit(self, _solenoid.new_KSC_TriggerConfig())
    __swig_destroy__ = _solenoid.delete_KSC_TriggerConfig

# Register KSC_TriggerConfig in _solenoid:
_solenoid.KSC_TriggerConfig_swigregister(KSC_TriggerConfig)
...
def SC_GetCycleParams(serialNo, onTime, offTime, numCycles):
    return _solenoid.SC_GetCycleParams(serialNo, onTime, offTime, numCycles)

def SC_SetCycleParams(serialNo, onTime, offTime, numCycles):
    return _solenoid.SC_SetCycleParams(serialNo, onTime, offTime, numCycles)
...
def SC_RequestMMIParams(serialNo):
    return _solenoid.SC_RequestMMIParams(serialNo)

def SC_GetMMIParamsExt(serialNo, displayIntensity, displayTimeout, displayDimIntensity):
    return _solenoid.SC_GetMMIParamsExt(serialNo, displayIntensity, displayTimeout, displayDimIntensity)

def SC_GetMMIParams(serialNo, displayIntensity):
    return _solenoid.SC_GetMMIParams(serialNo, displayIntensity)

def SC_SetMMIParamsExt(serialNo, displayIntensity, displayTimeout, displayDimIntensity):
    return _solenoid.SC_SetMMIParamsExt(serialNo, displayIntensity, displayTimeout, displayDimIntensity)

def SC_SetMMIParams(serialNo, displayIntensity):
    return _solenoid.SC_SetMMIParams(serialNo, displayIntensity)

def SC_RequestTriggerConfigParams(serialNo):
    return _solenoid.SC_RequestTriggerConfigParams(serialNo)

def SC_GetTriggerConfigParams(serialNo, trigger1Mode, trigger1Polarity, trigger2Mode, trigger2Polarity):
    return _solenoid.SC_GetTriggerConfigParams(serialNo, trigger1Mode, trigger1Polarity, trigger2Mode, trigger2Polarity)

def SC_SetTriggerConfigParams(serialNo, trigger1Mode, trigger1Polarity, trigger2Mode, trigger2Polarity):
    return _solenoid.SC_SetTriggerConfigParams(serialNo, trigger1Mode, trigger1Polarity, trigger2Mode, trigger2Polarity)

def SC_GetTriggerConfigParamsBlock(serialNo, triggerConfigParams):
    return _solenoid.SC_GetTriggerConfigParamsBlock(serialNo, triggerConfigParams)

def SC_SetTriggerConfigParamsBlock(serialNo, triggerConfigParams):
    return _solenoid.SC_SetTriggerConfigParamsBlock(serialNo, triggerConfigParams)

def SC_RequestDigitalOutputs(serialNo):
    return _solenoid.SC_RequestDigitalOutputs(serialNo)

def SC_GetDigitalOutputs(serialNo):
    return _solenoid.SC_GetDigitalOutputs(serialNo)

def SC_SetDigitalOutputs(serialNo, outputsBits):
    return _solenoid.SC_SetDigitalOutputs(serialNo, outputsBits)
