...
LD_WheelAndSoftware = _laser_diode.LD_WheelAndSoftware
LD_ILim = _laser_diode.LD_ILim
LD_ILD = _laser_diode.LD_ILD
LD_IPD = _laser_diode.LD_IPD
LD_PLD = _laser_diode.LD_PLD
LD_TIA_1_10uA = _laser_diode.LD_TIA_1_10uA
LD_TIA_2_100uA = _laser_diode.LD_TIA_2_100uA
LD_TIA_3_1mA = _laser_diode.LD_TIA_3_1mA
LD_TIA_4_10mA = _laser_diode.LD_TIA_4_10mA
LD_CathodeGrounded = _laser_diode.LD_CathodeGrounded
LD_AnodeGrounded = _laser_diode.LD_AnodeGrounded
KLD_RampUpImmediate = _laser_diode.KLD_RampUpImmediate
KLD_RampUpRamped = _laser_diode.KLD_RampUpRamped
KLD_Disabled = _laser_diode.KLD_Disabled
KLD_Input = _laser_diode.KLD_Input
KLD_Output = _laser_diode.KLD_Output
KLD_LaserOn = _laser_diode.KLD_LaserOn
KLD_InterlockEnabled = _laser_diode.KLD_InterlockEnabled
KLD_SetPointChange = _laser_diode.KLD_SetPointChange
KLD_HighStability = _laser_diode.KLD_HighStability
KLD_LowStability = _laser_diode.KLD_LowStability
KLD_TrigPol_High = _laser_diode.KLD_TrigPol_High
KLD_TrigPol_Low = _laser_diode.KLD_TrigPol_Low
class KLD_MMIParams(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    displayIntensity = property(_laser_diode.KLD_MMIParams_displayIntensity_get, _laser_diode.KLD_MMIParams_displayIntensity_set)
    reserved = property(_laser_diode.KLD_MMIParams_reserved_get, _laser_diode.KLD_MMIParams_reserved_set)

    def __init__(self):
        _laser_diode.KLD_MMIParams_swiginit(self, _laser_diode.new_KLD_MMIParams())
    __swig_destroy__ = _laser_diode.delete_KLD_MMIParams

# Register KLD_MMIParams in _laser_diode:
_laser_diode.KLD_MMIParams_swigregister(KLD_MMIParams)
class KLD_TrigIOParams(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    mode1 = property(_laser_diode.KLD_TrigIOParams_mode1_get, _laser_diode.KLD_TrigIOParams_mode1_set)
    polarity1 = property(_laser_diode.KLD_TrigIOParams_polarity1_get, _laser_diode.KLD_TrigIOParams_polarity1_set)
    reserved1 = property(_laser_diode.KLD_TrigIOParams_reserved1_get, _laser_diode.KLD_TrigIOParams_reserved1_set)
    mode2 = property(_laser_diode.KLD_TrigIOParams_mode2_get, _laser_diode.KLD_TrigIOParams_mode2_set)
    polarity2 = property(_laser_diode.KLD_TrigIOParams_polarity2_get, _laser_diode.KLD_TrigIOParams_polarity2_set)
    reserved2 = property(_laser_diode.KLD_TrigIOParams_reserved2_get, _laser_diode.KLD_TrigIOParams_reserved2_set)

    def __init__(self):
        _laser_diode.KLD_TrigIOParams_swiginit(self, _laser_diode.new_KLD_TrigIOParams())
    __swig_destroy__ = _laser_diode.delete_KLD_TrigIOParams

# Register KLD_TrigIOParams in _laser_diode:
_laser_diode.KLD_TrigIOParams_swigregister(KLD_TrigIOParams)
...
def LD_CanDeviceLockFrontPanel(serialNo):
    return _laser_diode.LD_CanDeviceLockFrontPanel(serialNo)

def LD_GetFrontPanelLocked(serialNo):
    return _laser_diode.LD_GetFrontPanelLocked(serialNo)

def LD_RequestFrontPanelLocked(serialNo):
    return _laser_diode.LD_RequestFrontPanelLocked(serialNo)

def LD_SetFrontPanelLock(serialNo, locked):
    return _laser_diode.LD_SetFrontPanelLock(serialNo, locked)
...
def LD_RequestMaxCurrent(serialNo):
    return _laser_diode.LD_RequestMaxCurrent(serialNo)

def LD_SetMaxCurrent(serialNo, maxCurrent):
    return _laser_diode.LD_SetMaxCurrent(serialNo, maxCurrent)

def LD_FindTIAGain(serialNo):
    return _laser_diode.LD_FindTIAGain(serialNo)

def LD_StopFindTIAGain(serialNo):
    return _laser_diode.LD_StopFindTIAGain(serialNo)
...
def LD_RequestRampupMode(serialNo):
    return _laser_diode.LD_RequestRampupMode(serialNo)

def LD_GetRampupMode(serialNo):
    return _laser_diode.LD_GetRampupMode(serialNo)

def LD_SetRampupMode(serialNo, rampupMode):
    return _laser_diode.LD_SetRampupMode(serialNo, rampupMode)

def LS_RequestMMIParams(serialNo):
    return _laser_diode.LS_RequestMMIParams(serialNo)

def LS_GetMMIParamsBlock(serialNo, params):
    return _laser_diode.LS_GetMMIParamsBlock(serialNo, params)

def LS_SetMMIParamsBlock(serialNo, params):
    return _laser_diode.LS_SetMMIParamsBlock(serialNo, params)

def LS_RequestTrigIOParams(serialNo):
    return _laser_diode.LS_RequestTrigIOParams(serialNo)

def LS_GetTrigIOParams(serialNo, mode1, polarity1, mode2, polarity2):
    return _laser_diode.LS_GetTrigIOParams(serialNo, mode1, polarity1, mode2, polarity2)

def LS_SetTrigIOParams(serialNo, mode1, polarity1, mode2, polarity2):
    return _laser_diode.LS_SetTrigIOParams(serialNo, mode1, polarity1, mode2, polarity2)

def LS_GetTrigIOParamsBlock(serialNo, params):
    return _laser_diode.LS_GetTrigIOParamsBlock(serialNo, params)

def LS_SetTrigIOParamsBlock(serialNo, params):
    return _laser_diode.LS_SetTrigIOParamsBlock(serialNo, params)
