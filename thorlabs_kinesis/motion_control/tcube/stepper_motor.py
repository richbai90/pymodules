...
TBD1 = _stepper_motor.TBD1
TBD2 = _stepper_motor.TBD2
TBD3 = _stepper_motor.TBD3
TBD4 = _stepper_motor.TBD4
NR360 = _stepper_motor.NR360
MVS025 = _stepper_motor.MVS025
PLS_X25MM = _stepper_motor.PLS_X25MM
PLS_X25MM_HiRes = _stepper_motor.PLS_X25MM_HiRes
FW103 = _stepper_motor.FW103
NEWZFS06 = _stepper_motor.NEWZFS06
NEWZFS13 = _stepper_motor.NEWZFS13
NEWZFS25 = _stepper_motor.NEWZFS25
NEWZST06 = _stepper_motor.NEWZST06
NEWZST13 = _stepper_motor.NEWZST13
NEWZST25 = _stepper_motor.NEWZST25
...
class MOT_ButtonParameters(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    buttonMode = property(_stepper_motor.MOT_ButtonParameters_buttonMode_get, _stepper_motor.MOT_ButtonParameters_buttonMode_set)
    leftButtonPosition = property(_stepper_motor.MOT_ButtonParameters_leftButtonPosition_get, _stepper_motor.MOT_ButtonParameters_leftButtonPosition_set)
    rightButtonPosition = property(_stepper_motor.MOT_ButtonParameters_rightButtonPosition_get, _stepper_motor.MOT_ButtonParameters_rightButtonPosition_set)
    timeout = property(_stepper_motor.MOT_ButtonParameters_timeout_get, _stepper_motor.MOT_ButtonParameters_timeout_set)
    unused = property(_stepper_motor.MOT_ButtonParameters_unused_get, _stepper_motor.MOT_ButtonParameters_unused_set)

    def __init__(self):
        _stepper_motor.MOT_ButtonParameters_swiginit(self, _stepper_motor.new_MOT_ButtonParameters())
    __swig_destroy__ = _stepper_motor.delete_MOT_ButtonParameters

# Register MOT_ButtonParameters in _stepper_motor:
_stepper_motor.MOT_ButtonParameters_swigregister(MOT_ButtonParameters)
class MOT_PotentiometerStep(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    thresholdDeflection = property(_stepper_motor.MOT_PotentiometerStep_thresholdDeflection_get, _stepper_motor.MOT_PotentiometerStep_thresholdDeflection_set)
    velocity = property(_stepper_motor.MOT_PotentiometerStep_velocity_get, _stepper_motor.MOT_PotentiometerStep_velocity_set)

    def __init__(self):
        _stepper_motor.MOT_PotentiometerStep_swiginit(self, _stepper_motor.new_MOT_PotentiometerStep())
    __swig_destroy__ = _stepper_motor.delete_MOT_PotentiometerStep

# Register MOT_PotentiometerStep in _stepper_motor:
_stepper_motor.MOT_PotentiometerStep_swigregister(MOT_PotentiometerStep)
class MOT_PotentiometerSteps(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    potentiometerStepParameters = property(_stepper_motor.MOT_PotentiometerSteps_potentiometerStepParameters_get, _stepper_motor.MOT_PotentiometerSteps_potentiometerStepParameters_set)

    def __init__(self):
        _stepper_motor.MOT_PotentiometerSteps_swiginit(self, _stepper_motor.new_MOT_PotentiometerSteps())
    __swig_destroy__ = _stepper_motor.delete_MOT_PotentiometerSteps

# Register MOT_PotentiometerSteps in _stepper_motor:
_stepper_motor.MOT_PotentiometerSteps_swigregister(MOT_PotentiometerSteps)
...
def SCC_RequestLEDswitches(serialNo):
    return _stepper_motor.SCC_RequestLEDswitches(serialNo)

def SCC_GetLEDswitches(serialNo):
    return _stepper_motor.SCC_GetLEDswitches(serialNo)

def SCC_SetLEDswitches(serialNo, LEDswitches):
    return _stepper_motor.SCC_SetLEDswitches(serialNo, LEDswitches)
...
def SCC_RequestButtonParams(serialNo):
    return _stepper_motor.SCC_RequestButtonParams(serialNo)

def SCC_GetButtonParams(serialNo, buttonMode, leftButtonPosition, rightButtonPosition, timeout):
    return _stepper_motor.SCC_GetButtonParams(serialNo, buttonMode, leftButtonPosition, rightButtonPosition, timeout)

def SCC_SetButtonParams(serialNo, buttonMode, leftButtonPosition, rightButtonPosition):
    return _stepper_motor.SCC_SetButtonParams(serialNo, buttonMode, leftButtonPosition, rightButtonPosition)

def SCC_RequestPotentiometerParams(serialNo):
    return _stepper_motor.SCC_RequestPotentiometerParams(serialNo)

def SCC_GetPotentiometerParams(serialNo, index, thresholdDeflection, velocity):
    return _stepper_motor.SCC_GetPotentiometerParams(serialNo, index, thresholdDeflection, velocity)

def SCC_SetPotentiometerParams(serialNo, index, thresholdDeflection, velocity):
    return _stepper_motor.SCC_SetPotentiometerParams(serialNo, index, thresholdDeflection, velocity)
...
def SCC_GetButtonParamsBlock(serialNo, buttonParams):
    return _stepper_motor.SCC_GetButtonParamsBlock(serialNo, buttonParams)

def SCC_SetButtonParamsBlock(serialNo, buttonParams):
    return _stepper_motor.SCC_SetButtonParamsBlock(serialNo, buttonParams)

def SCC_GetPotentiometerParamsBlock(serialNo, potentiometerSteps):
    return _stepper_motor.SCC_GetPotentiometerParamsBlock(serialNo, potentiometerSteps)

def SCC_SetPotentiometerParamsBlock(serialNo, potentiometerSteps):
    return _stepper_motor.SCC_SetPotentiometerParamsBlock(serialNo, potentiometerSteps)
