...
def SBC_GetVelParamsBlock(serialNo, channel, velocityParameters):
    return _stepper_motor.SBC_GetVelParamsBlock(serialNo, channel, velocityParameters)

def SBC_SetVelParamsBlock(serialNo, channel, velocityParameters):
    return _stepper_motor.SBC_SetVelParamsBlock(serialNo, channel, velocityParameters)
...
def SBC_GetJogParamsBlock(serialNo, channel, jogParameters):
    return _stepper_motor.SBC_GetJogParamsBlock(serialNo, channel, jogParameters)

def SBC_SetJogParamsBlock(serialNo, channel, jogParameters):
    return _stepper_motor.SBC_SetJogParamsBlock(serialNo, channel, jogParameters)
