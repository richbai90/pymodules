%module position_readout_encoder

%include <windows.i> // Required for Windows-specific types

#define POSITIONREADOUTENCODERDLL_EXPORTS 


%{
#define POSITIONREADOUTENCODERDLL_EXPORTS 
#define PY_ARRAY_UNIQUE_SYMBOL position_readout_encoder_PY_ARRAY_UNIQUE_SYMBOL
#define SWIG_FILE_WITH_INIT
#include "Thorlabs.MotionControl.PositionReadoutEncoder.h"
%}
