...
NT_CurrentLimit_100mA = _nano_trak.NT_CurrentLimit_100mA
NT_CurrentLimit_250mA = _nano_trak.NT_CurrentLimit_250mA
NT_CurrentLimit_500mA = _nano_trak.NT_CurrentLimit_500mA
NT_OutputFilter_10Hz = _nano_trak.NT_OutputFilter_10Hz
NT_OutputFilter_100Hz = _nano_trak.NT_OutputFilter_100Hz
NT_OutputFilter_5kHz = _nano_trak.NT_OutputFilter_5kHz
NT_OutputFilter_None = _nano_trak.NT_OutputFilter_None
NT_FeedbackSignalDC = _nano_trak.NT_FeedbackSignalDC
NT_FeedbackSignalAC = _nano_trak.NT_FeedbackSignalAC
NT_BNCModeTrigger = _nano_trak.NT_BNCModeTrigger
NT_BNCModeLVOut = _nano_trak.NT_BNCModeLVOut
class BNT_IO_Settings(object):
    thisown = property(lambda x: x.this.own(), lambda x, v: x.this.own(v), doc="The membership flag")
    __repr__ = _swig_repr
    channel = property(_nano_trak.BNT_IO_Settings_channel_get, _nano_trak.BNT_IO_Settings_channel_set)
    amplifierCurrentLimit = property(_nano_trak.BNT_IO_Settings_amplifierCurrentLimit_get, _nano_trak.BNT_IO_Settings_amplifierCurrentLimit_set)
    amplifierLowPassFilter = property(_nano_trak.BNT_IO_Settings_amplifierLowPassFilter_get, _nano_trak.BNT_IO_Settings_amplifierLowPassFilter_set)
    feedbackSignal = property(_nano_trak.BNT_IO_Settings_feedbackSignal_get, _nano_trak.BNT_IO_Settings_feedbackSignal_set)
    BNCtriggerOrLowVoltageOut = property(_nano_trak.BNT_IO_Settings_BNCtriggerOrLowVoltageOut_get, _nano_trak.BNT_IO_Settings_BNCtriggerOrLowVoltageOut_set)

    def __init__(self):
        _nano_trak.BNT_IO_Settings_swiginit(self, _nano_trak.new_BNT_IO_Settings())
    __swig_destroy__ = _nano_trak.delete_BNT_IO_Settings

# Register BNT_IO_Settings in _nano_trak:
_nano_trak.BNT_IO_Settings_swigregister(BNT_IO_Settings)
...
def NT_GetIOsettingsBlock(serialNo, IOsettings, channel):
    return _nano_trak.NT_GetIOsettingsBlock(serialNo, IOsettings, channel)

def NT_SetIOsettingsBlock(serialNo, IOsettings, channel):
    return _nano_trak.NT_SetIOsettingsBlock(serialNo, IOsettings, channel)
