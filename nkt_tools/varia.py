...
class Varia:
    ...
    def set_center_wavelength(self, wavelength: int, bandwidth: int) -> tuple:
        """
        Sets the long and short setpoints to give the provided center wavelength and bandwidth.
